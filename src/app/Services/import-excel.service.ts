...
importPositionMasterdata(formData): Observable<any> {
    ...
    //Import Ship Spare Assemblies
    ImportShipSpareAssem(formData): Observable<any> {
      return this.httpClient.post<any>(this.linkurlshippms + 'ImportShipSpareAssem', formData)
      .pipe(catchError(this.handleError));
    }

    //Import Ship Spare Assemblies
    ImportShipCounterMaster(formData): Observable<any> {
    return this.httpClient.post<any>(this.linkurlshippms + 'ImportShipCountermastr', formData)
    .pipe(catchError(this.handleError));
    }
