...
import { SwalToastService } from '../Services/swal-toast.service';
...
export class AuthGuardService implements CanActivate{
  ...
  constructor(private jwtHelper: JwtHelperService,private swal: SwalToastService,
    ...
    async canActivate(route: ActivatedRouteSnapshot, 
      ...
      if (!isRefreshSuccess) {
      //  this.swal.infoPopUp("Your session has expired. please log in again to continue")        
